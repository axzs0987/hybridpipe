...
specific_split = 0
class Logger(object):
    def __init__(self, filename='HAIPipeGen/human_run_continue_'+str(specific_split)+'.log', stream=sys.stdout):
...
sys.stdout = Logger('HAIPipeGen/human_run_continue.log', sys.stdout)
sys.stderr = Logger('HAIPipeGen/human_run_continue.log', sys.stderr)
...
class Preprocessing:
    def __init__(self):
        ...
        self.info_triple = np.load('HAIPipeGen/merged_info_triple.npy', allow_pickle=True).item()
        self.suc = 0
        self.change_suc = 0
        ...
        self.res_data_path = 'HAIPipeGen/hi_res_data/'
        self.val_res_data_path = 'HAIPipeGen/hi_val_res_data/'
