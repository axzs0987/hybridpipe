from HybridPipeGen.core.al.utils.load_code import py2str
import time
import os
import json
import numpy as np
...
class Runner:
    ...
    def exchange_code(self, code):
        ...
        # if not os.path.exists('new_data/runned_notebook/'+ str(self.notebook_id) + '.py'):
